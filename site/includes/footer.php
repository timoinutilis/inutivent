...
?>
			...
			<div id="footer" class="section">
				<div class="inside">
					<div class="column">
						<p>
							<?php printf( _('Gromf helps you to invite friends to your events, without the need to register and without collecting personal data. <a href="%1$s">More information</a>'), SITE_URL.'#more-info'); ?>
						</p>
